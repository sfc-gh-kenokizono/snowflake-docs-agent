...
GRANT USAGE ON DATABASE SHARED_CORTEX_AGENTS_DB TO ROLE PUBLIC;
GRANT USAGE ON SCHEMA SHARED_CORTEX_AGENTS_DB.SHARED_AGENTS TO ROLE PUBLIC;
GRANT CREATE AGENT ON SCHEMA SHARED_CORTEX_AGENTS_DB.SHARED_AGENTS TO ROLE PUBLIC;
...
-- エージェントの削除
DROP AGENT IF EXISTS SHARED_CORTEX_AGENTS_DB.SHARED_AGENTS.SNOWFLAKE_DOCS_AGENT;
...
DROP DATABASE IF EXISTS SHARED_CORTEX_AGENTS_DB;
