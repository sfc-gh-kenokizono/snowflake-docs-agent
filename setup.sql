...
GRANT USAGE ON SCHEMA SHARED_CORTEX_AGENTS_DB.AGENTS TO ROLE PUBLIC;
GRANT CREATE AGENT ON SCHEMA SHARED_CORTEX_AGENTS_DB.AGENTS TO ROLE PUBLIC;
...
-- エージェントの削除
DROP AGENT IF EXISTS SHARED_CORTEX_AGENTS_DB.AGENTS.SNOWFLAKE_DOCS_AGENT;
